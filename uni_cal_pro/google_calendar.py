...
# WARNING NEED TO UPDATE THIS SO THAT IT TAKES A USER AS AN ARGUMENT TO ALLOW MULTIPLE USERS.
def get_user_credentials():
  """Get the credentials needed to manipulate a user's calendar and if they didn't already exist then store them in the config folder."""
...
def connect(google_calendar_token):
  return build("calendar", "v3", credentials=google_calendar_token)
